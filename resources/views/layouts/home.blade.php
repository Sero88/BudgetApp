...
<head>
    ...
    <!--Font Awesome --> 
    <script src="https://kit.fontawesome.com/2fed3ab15b.js" crossorigin="anonymous" async></script>
...
<body>
    <div id="app">
        <nav class="navbar navbar-main navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ '/balances' }}">View All</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('transactions.create') }}#new-transaction">New</a>
